// @mbtech-nl/multimeter-web-bluetooth — the browser transport + the framework-agnostic
// MeterSession engine. Depends on @mbtech-nl/multimeter-protocol; consumed by the React/Vue
